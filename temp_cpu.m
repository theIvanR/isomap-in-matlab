...
% Options in optsIn:
%   dims        : vector of dims to compute (default 1:10)
%   comp        : connected component index to embed (default 1 largest)
%   overlay     : return adjacency matrix (0/1) (default 0)
%   verbose     : (default 1)
%   approxLandmarks : number of landmarks (0 means exact Isomap) (default 0)
%
% This function is aggressive about speed on CPU. It uses sparse adjacency
% + graph/distance (Dijkstra) instead of Floyd-Warshall loops.
...
A = sparse(i_list, j_list, (w_list), N, N);
